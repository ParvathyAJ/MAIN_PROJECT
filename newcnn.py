...
def predict(fn):
    ...
    print(mo)
    # model_json = mo.to_json()
    # with open("model.json", "w") as json_file:
    #     json_file.write(model_json)

    # yhat_classes = mo.predict_classes(dataset, verbose=33)
    # print(yhat_classes,"===============")
...
print(predict(r"C:\Users\aj\Downloads\bacteria_classification\bacteria_classification\static\datasets\Acinetobacter_baumanii\Acinetobacter.baumanii_0002.jpg"))