...
def read_dataset(path):
    ...
    label_list = []
    i=0
    my_list = os.listdir(r'C:\Users\aj\Downloads\bacteria_classification\bacteria_classification\static\datasets')
    for pa in my_list:

        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'C:\Users\aj\Downloads\bacteria_classification\bacteria_classification\static\datasets\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\aj\Downloads\bacteria_classification\bacteria_classification\static\datasets\\'+pa, f)
...
y_train1=[]
for i in y_train:
    yy = keras.utils.to_categorical(i, num_classes)
    print(i, yy)
    y_train1.append(yy)
...
def predict(fn):
   ...
   # predict(r"C:\Users\aj\Downloads\bacteria_classification\bacteria_classification\static/datasets/Porfyromonas_gingivalis/Porfyromonas.gingivalis_0005.jpg")